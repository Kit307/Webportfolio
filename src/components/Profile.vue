    ...
    <div>
      ...
      <div class="p-4" id="stats" role="tabpanel" aria-labelledby="stats-tab">
        ...
        >
          ...
          <div class="flex flex-col items-center justify-center hover:shadow-lg hover:shadow-green-400 dark:hover:shadow-neutral-300 transition ease-in hover:bg-emerald-100 dark:hover:bg-slate-800">
